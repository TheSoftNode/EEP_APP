...
export const SignupForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        setIsLoading(true);
        // Add signup logic here with the selected role
        ...
        setTimeout(() => {
            ...
            if (userRole === "business") {
                window.location.href = "/EEP/business-application";
            } else {
                window.location.href = "/EEP/learner-dashboard";
            }
        }, 1500);
    };
            ...
            <div className="relative z-10 container max-w-lg mx-auto pt-20 px-4">
                ...
                >
                    <Card className="backdrop-blur-sm bg-white/80">
                        ...
                        <Tabs defaultValue="learner" className="w-full px-6" onValueChange={setUserRole}>
                            ...
                            <TabsContent value="learner">
                                <p className="text-sm text-gray-500 mb-4">
                                    Join as a learner to access projects, develop your skills, and showcase your work.
                                </p>
                            </TabsContent>

                            <TabsContent value="business">
                                <p className="text-sm text-gray-500 mb-4">
                                    Join as a business to submit projects, find talented developers, and track project progress.
                                </p>
                            </TabsContent>
                        </Tabs>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                {userRole === "learner" && (
                                    <div className="space-y-2">
                                        ...
                                        <Select>
                                            <SelectTrigger className="bg-white">
                                                <SelectValue placeholder="Primary skill" />
                                            </SelectTrigger>
                                            <SelectContent>
